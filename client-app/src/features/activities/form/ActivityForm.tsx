...
export default function ActivityForm({ activity: selectedActivity, onCloseForm ,onCreateOrEdit,submitting}: Props) {
    ...
    return (
        <Segment clearing>
            <Form>
                ...
                <Button loading={submitting} onClick={handleSubmit} float='right' positive type='submit' content='Submit' />
